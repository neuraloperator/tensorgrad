...
pipe = ConfigPipeline([
    YamlConfig('fnogno_carcfd_config.yaml', config_name=config_name, config_folder='./config'),
...
print(f"  - Train samples: {len(data_module.train_data)}")
print(f"  - Test samples: {len(data_module.test_data)}")
print(f"  - Config n_train: {config.data.n_train}")
print(f"  - Config n_test: {config.data.n_test}")
